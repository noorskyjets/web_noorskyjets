...
export const translations = {
  en: {
    ...
    contact: {
      ...
      formMobileLead: 'Alternatively, leave us your contact details and requirements and we will contact you as soon as possible.',
      ...
      formValidation: 'Please enter your name and a valid contact address.',
    },
  },
  es: {
    meta: {
    ...
    contact: {
      ...
      missionOptions: {
        ...
        options: [
          ...
          'Asesoría de Aeronaves',
          'Otros',
        ],
      },
      formMobileLead: 'Si lo deseas, déjanos tu contacto y tu necesidad y contactaremos lo antes posible.',
      ...
      formValidation: 'Indica tu nombre y un contacto válido.',
    },
  },
  fr: {
    meta: {
    ...
    contact: {
      ...
      formMobileLead: 'Si vous le souhaitez, laissez-nous vos coordonnées et vos besoins et nous vous contacterons dès que possible.',
